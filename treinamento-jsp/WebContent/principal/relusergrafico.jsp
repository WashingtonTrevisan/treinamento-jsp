											...
											<div class="col-sm-12">
												...
												<div class="card">
													<div class="card-block">
														<h4 class="sub-title">Gráfico de Salários</h4>
														...
														<form
															...
															<div class="form-row align-items-center">
																...
																<!-- Função Java Script para gerar o Gráfico -->
																<div class="col-auto">
...
//Criando uma variável global para criar o gráfico:	
var myChart = new Chart(document.getElementById('myChart'));	
	

//<!-- Função JS para gerar gráfico de salários na tela -->	
//<!-- Criando função Gerar Gráficos com Ajax -->
//<!-- Obs: usando o Ajax não existe redirecionamento para páginas e formulários -->	
	...
	$.ajax({
		...
		myChart = new Chart(
			   document.getElementById('myChart'),
				  ...
				  datasets: [{
				   	label: 'Gráfico de média salarial por cargo',
		...
		alert('Erro ao buscar dados para gerar o gráfico' + xhr.responseText);
	}); 			
}
